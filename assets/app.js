/* MartinMaxwin — monthly Rainbet wager leaderboard.
   ...
   creators/martinmaxwin.json, which is also what writes them into
...
(() => {
  ...
  async function runSearch() {
    ...
    if (!match) {
      setResult(`No wagers found for "${query}" this cycle. Make sure you signed up with code MAXWINMARTIN and that the spelling matches exactly.`, 'miss');
      return;
    }
