# MartinMaxwin — Rainbet wager leaderboard

Live at **https://martinmaxwin.com/**

A one-page static site showing a $250 monthly wager leaderboard for Rainbet
affiliate code **MAXWINMARTIN**. Generated from the Forge Partners leaderboard
...
| Setting | Value |
| --- | --- |
| Affiliate code | `MAXWINMARTIN` |
| Referral link | https://rainbet.com?r=maxwinmartin |
...
5. **Point the domain** at Netlify and wait for the TLS certificate. A new
   ...
   certificate is actually issued for `martinmaxwin.com` before telling anyone the
   site is live.
...
`creators/martinmaxwin.json` in the template repo. Edit that, re-run
`node new-creator.mjs martinmaxwin`, and copy the regenerated files over. The cycle
